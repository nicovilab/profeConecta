...
public class SearchAdDialog {
    ...
    public JPanel createCardsPanel(List<AnuncioDTO> anuncios) {
    ...
    public JPanel createAdCardPanel(AnuncioDTO anuncio) {
    ...
    JLabel fechaLabel = new JLabel("Fecha: " + new SimpleDateFormat("dd/MM/yyyy").format(anuncio.getFechaPublicacion()));
