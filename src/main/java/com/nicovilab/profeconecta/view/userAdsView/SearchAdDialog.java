...
public class SearchAdDialog {
    ...
    // Encabezado: Materia y Precio en la misma fila, luego Fecha
    ...
    JLabel precioLabel = new JLabel("Precio: " + anuncio.getPrecioHora() + "€");
    precioLabel.setFont(LABEL_BOLD_FONT);
    precioLabel.setAlignmentX(Component.LEFT_ALIGNMENT);

    JPanel materiaPrecioPanel = new JPanel();
    materiaPrecioPanel.setLayout(new BoxLayout(materiaPrecioPanel, BoxLayout.X_AXIS));
    materiaPrecioPanel.setBackground(BG_COLOR);
    materiaPrecioPanel.setAlignmentX(Component.LEFT_ALIGNMENT);

    materiaPrecioPanel.add(materiaLabel);
    materiaPrecioPanel.add(Box.createHorizontalStrut(15));
    materiaPrecioPanel.add(precioLabel);
    ...
    headerRight.add(materiaPrecioPanel);
